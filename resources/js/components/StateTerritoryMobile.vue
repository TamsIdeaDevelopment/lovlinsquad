    ...
    <div>
        <div class="form-group">
            ...
            <div class="input-group input-group-merge ">
                ...
                <select class="form-control" style="width:100%" id="update-select-country-mobile" v-model="country" name="country" required>
        ...
        <div>
            <div class="form-group">
                ...
                <div class="input-group input-group-merge ">
                    ...
                    <select class="form-control" style="width:100%" id="update-select-state-mobile" v-model="state_id" name="state" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group input-group-merge ">
                    ...
                    <select class="form-control"style="width:100%" id="update-select-territory-mobile" v-model="territory_id" name="territory" required>
...
<script>
    export default {
        ...
        mounted() {
            $("#update-select-country-mobile").change(function(){
                this.isMalaysia = false;
                this.country = $("#update-select-country-mobile").val();
...
//                    this.isMalaysia = !this.isMalaysia;
            ...
            $("#update-select-state-mobile").change(function(){
                this.state_id = $("#update-select-state-mobile").val();
                console.log(this.state_id);
                this.getTerritoryName();

            }.bind(this));
            $("#update-select-territory-mobile").change(function(){
                this.territory_id = $("#update-select-territory-mobile").val();
