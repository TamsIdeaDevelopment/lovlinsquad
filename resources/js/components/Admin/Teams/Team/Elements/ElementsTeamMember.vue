<template>
    <table style="width:100%" class="table table-separate table-head-custom table-checkable responsive display nowrap" id="table-team-member">
        ...
        <tr v-for="(Team, index) in data">
            <td>{{index+1}}</td>
            <td>
                <a v-if="!Team.member_no" :href="'/agent-details/'+Team.user_id.id">TMP{{String('00000' + Team.id).slice(-5)}}</a>
                <a v-if="Team.member_no" :href="'/agent-details/'+Team.user_id.id">LN{{String('00000' + Team.member_no).slice(-5)}}</a>
            </td>
            <td>
                <div class="row">
                    <div class="col-12">
            ...
            <td>
                ...
                <!--<div class="row mb-1" v-if="$parent.data2.role_id == 1">-->
                    <!--<div class="col-12" v-if="Team.status == 0">-->
