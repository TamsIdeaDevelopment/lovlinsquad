<template>
    <div class="modal fade newState" id="newState" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        ...
        methods:
            {
                CreateState() {
                    ...
                    if((this.State.name !== ''))
                    {
                        var url = '/api/v1/state/Creates/create-state', method = 'post';
                        ...
                        fetch(url, {
                            ...
                            toastr.success("Successfully Register New State.", "State Created");
                        })
                    }

                    if(!this.State.name)
                    {
                        this.errors['name'] = "Please enter the state name"
                    }
                },
                clearForm(){
                    this.Roles = {
