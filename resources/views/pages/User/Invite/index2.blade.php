        ...
        <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
            <div class="container">
                <a class="navbar-brand" href="{{ route('/') }}">
                    <img src="https://www.lovlin.com/wp-content/uploads/2020/09/logo_lovlin_web_3.png" alt="logo" class="img-fluid" style="width:150px; height: 50px;" />
                </a>
                <a href="{{ route('login') }}">
                    ...
                    <div class="col-md-9 col-lg-12">
                        <div class="hero-slider-content text-white text-center my-lg-5">
                            ...
                            <p class="lead">Waktu getir dan susah dalam pandemik yang melanda seluruh dunia ini memang tidak disangka-sangka.<br>Ada yang terpaksa dipotong gaji dan ada juga yang terpaksa diberhentikan kerja.<br><br> Tapi,jangan jadikan pandemik ini sebagai
                                pematah semangat anda. Kami di Lovlin <br>ingin berkongsi rezeki kepada kepada anda yang terjejas.</p>
                        </div>
                    </div>
                ...
                <div class="row justify-content-around align-items-center ">
                    ...
                    <div class="col-md-4 ">
                        <div class="action-btn text-lg-right text-sm-left ">
                            <a href="{{ route('register') }} " class="btn secondary-solid-btn ">Saya mahu jana pendapatan bersama <br>kembara Meals</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="promo-section gradient-bg ptb-100 visible-xs ">
            <div class="container ">
                <div class="row justify-content-around align-items-center ">
                    ...
                    <div class="col-md-4 ">
                        <div class="action-btn text-lg-right text-sm-left ">
                            <a href="{{ route('register') }}" class="btn secondary-solid-btn ">Saya mahu jana pendapatan bersama kembara
                                Meals</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md ">
                        <div class="card text-center single-pricing-pack ">
                            ...
                            <div class="card-body ">
                                ...
                                <a href="{{ route('register') }}" class="btn secondary-solid-btn mb-3 ">Daftar Sekarang</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md ">
            ...
            <div class="container ">
                <div class="row justify-content-center ">
                    <div class="col-lg-8 ">
                        <div class="section-heading text-center mb-5 ">
                            <br>
                            <h3>Kenapa Tunggu Lagi?<br> Rebutlah peluang keemasan ini dengan<br> sertai ejen Lovlin Sekarang!</h3>
                            <p class="lead ">Langkah pertam untuk menggapai impian? Isi borang pendaftaran ini dahulu dan <br>team Lovlin akan bantu anda ke peringkat seterusnya.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container ">
                <div class="row justify-content-center ">
                    <div class="col-lg-8 ">
                        <div class="section-heading text-center mb-5 ">
                            <br>
                            <h3>Kenapa Tunggu Lagi? Rebutlah peluang keemasan ini dengan sertai ejen Lovlin
                                Sekarang!</h3>
                            <p class="lead ">Langkah pertam untuk menggapai impian? Isi borang pendaftaran ini dahulu dan
                                <br>team Lovlin akan bantu anda ke peringkat seterusnya.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="call-to-action py-5 gray-light-bg ">
            <div class="container ">
                <div class="row justify-content-around align-items-center ">
                    ...
                    <div class="col-md-4 ">
                        <div class="action-btn text-lg-right text-sm-left ">
                            <a href="{{ route('register') }}" class="btn secondary-solid-btn ">Saya Nak Sertai KEMBARA Meals</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container ">
                <div class="row align-items-center justify-content-between ">
                    <div class="col-md-5 col-lg-5 ">
                        <p class="text-white ">Copyrights © 2020. Lovlin All Right Reserved
                    </div>
                </div>
            </div>
        </div>
