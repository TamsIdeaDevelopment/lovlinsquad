...
<br/>
{{--<img src="{{ asset('assets3/image/logo.png') }}" style="margin-left:100px; height: 100px;">--}}
...
<br/>
<a style="background-color: #008CBA;border: none;color: white;padding: 16px 32px;text-align: center;text-decoration: none;  display: inline-block;  font-size: 16px;  margin: 4px 2px;  transition-duration: 0.4s;  cursor: pointer;" href="https://lovlinsquad.com/list-product">Buy Product</a>
<br/>
