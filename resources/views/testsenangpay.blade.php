...
$hashed_string = md5($secretkey.urldecode($_GET['detail']).urldecode($_GET['amount']).urldecode($_GET['order_id']));
...
<form name="order" method="get" action="https://sandbox.senangpay.my/payment/<?php echo $merchant_id; ?>">
